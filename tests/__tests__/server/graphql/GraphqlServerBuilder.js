      ...
      const cases = [
        {
          ...
          expected: {
            ...
            postWorkersPath: expect.stringMatching(/app\/server\/graphql\/post-workers\/customer$/u),
            redisOptions: null,
          },
        },
        {
          ...
          expected: {
            ...
            postWorkersPath: expect.stringMatching(/app\/server\/graphql\/post-workers\/admin$/u),
            redisOptions: null,
          },
        },
      ]
