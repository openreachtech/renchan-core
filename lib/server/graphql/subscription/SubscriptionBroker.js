...
export default class SubscriptionBroker {
  ...
  /**
   * get: LocalPubSub constructor.
   *
   * @returns {typeof LocalPubSub} - LocalPubSub constructor.
   */
  static get LocalPubSubCtor () {
    return LocalPubSub
  }
   ...
   * Create Local PubSub.
   *
   * @returns {LocalPubSub} - Local PubSub
   */
  static createLocalPubSub () {
    return this.LocalPubSubCtor.create()
  }
