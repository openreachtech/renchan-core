...
export default class RestfulApiRoutesBuilder {
  ...
  /**
   * Build fulfilled request body with Express request.
   *
   * @param {{
   *   expressRequest: ExpressType.Request
   * }} params - Parameters of this method.
   * @returns {RestfulApiType.RenderRequestBody} - Fulfilled request body.
   */
  buildFulfilledRequestBody ({
    expressRequest: {
      body,
      files = null,
    },
    ...
    return {
      ...body,
      ...files, // files is an object with file fields
    }
  }
